...
class CameraActivity : AppCompatActivity(), FrameInferface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var receivedImageID = intent.getIntExtra("ImageID", 0)

        boundingBoxOverlay = findViewById<BoundingBoxOverlay>(R.id.bbox_overlay)
        boundingBoxOverlay.setWillNotDraw(false)
        boundingBoxOverlay.setZOrderOnTop(true)
        frameAnalyser =
            FrameAnalyser(this, boundingBoxOverlay, viewBackgroundOfMessage, textViewMessage, receivedImageID)
        frameAnalyser.frameInterface = this
    ...
    override fun onRegister() {
        Log.e("DebugLog", "OnRegister Pass!")
